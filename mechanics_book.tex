...
Convert the speed 45 kilometers per hour $\frac{km}{hr}$ to meters per second $\frac{m}{s}$
...
We have kilometers in the numerator and hours in the denominator, so e have to make sure we write our unit fractions correctly to cancel them. First, let's convert the kilometers to meters.

\begin{equation}
45 \, \frac{\cancel{km}}{hr} \cdot \frac{10^3 \, m}{1 \, \cancel{km}} = 45,000 \, \frac{m}{hr}
\end{equation}

Now we can convert the hour to seconds. It may be helpful to convert to minutes first, then to seconds.

\begin{equation}
45,000 \, \frac{m}{\cancel{hr}} \cdot \frac{1 \, \cancel{hr}}{60 \, \cancel{min}} \cdot \frac{1 \, \cancel{min}}{60 \, s} = 12.5 \, \frac{m}{s}
\end{equation}
