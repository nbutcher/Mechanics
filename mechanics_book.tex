...
For finding the uncertainty in your measured value, it makes sense to look at an example. Suppose we measure a change in position and a time with some uncertainty.
